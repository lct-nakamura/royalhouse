  ...
  return (
    <>
      ...
      <main className="l-main">{children}</main>
       ...
       <Link to="https://www.royal-house.co.jp/campaign/" target="_blank" className="map-balloon__link" activeClassName="is-current"><img src={withPrefix("/images/bnr_cp_2024spring.png")} alt="グッドデザイン受賞記念！新築購入資金ドドーンと最大100万円プレゼント" className="pc" /><img src={withPrefix("/images/bnr_cp_2024spring-sp.png")} alt="グッドデザイン受賞記念！新築購入資金ドドーンと最大100万円プレゼント" className="sp" /></Link>
  </div>
