        ...
        <div className="article__contents">
          <div className="container">
            <section className="article__section article__section01">
              <h2>キャンペーン申し込みフォーム</h2>              
              <form id="mailformpro" action="../mail-campaign.php" method="POST">
                ...
                <div className="form-group row">
                  ...
                  <div className="input-group col-12 col-sm-8 ">
                    <input type="email" data-type="email" className="form-control" id="MfpField_04" placeholder="info@xxx.com" name="emailcampaign" required="required" />
                  </div>
                </div>
                <div className="form-group row">
