                    ...
                    <div className="w-100">
                      ...
                      <select className="custom-select" id="MfpField_05" name="都道府県" required="required">
                        ...
                        <optgroup label="北海道・東北地方">
                          <option value="北海道" name="都道府県[]">北海道</option>
                          <option value="青森県" name="都道府県[]">青森県</option>
                          <option value="岩手県" name="都道府県[]">岩手県</option>
                          <option value="秋田県" name="都道府県[]">秋田県</option>
                          <option value="宮城県" name="都道府県[]">宮城県</option>
                          <option value="山形県" name="都道府県[]">山形県</option>
                          <option value="福島県" name="都道府県[]">福島県</option>
                        </optgroup>
                        <optgroup label="関東地方">
                          <option value="栃木県" name="都道府県[]">栃木県</option>
                          <option value="群馬県" name="都道府県[]">群馬県</option>
                          <option value="茨城県" name="都道府県[]">茨城県</option>
                          <option value="埼玉県" name="都道府県[]">埼玉県</option>
                          <option value="東京都" name="都道府県[]">東京都</option>
                          <option value="千葉県" name="都道府県[]">千葉県</option>
                          <option value="神奈川県" name="都道府県[]">神奈川県</option>
                        </optgroup>
                        <optgroup label="中部地方">
                          <option value="山梨県" name="都道府県[]">山梨県</option>
                          <option value="長野県" name="都道府県[]">長野県</option>
                          <option value="新潟県" name="都道府県[]">新潟県</option>
                          <option value="富山県" name="都道府県[]">富山県</option>
                          <option value="石川県" name="都道府県[]">石川県</option>
                          <option value="福井県" name="都道府県[]">福井県</option>
                          <option value="静岡県" name="都道府県[]">静岡県</option>
                          <option value="岐阜県" name="都道府県[]">岐阜県</option>
                          <option value="愛知県" name="都道府県[]">愛知県</option>
                        </optgroup>
                        <optgroup label="近畿地方">
                          <option value="三重県" name="都道府県[]">三重県</option>
                          <option value="滋賀県" name="都道府県[]">滋賀県</option>
                          <option value="京都府" name="都道府県[]">京都府</option>
                          <option value="大阪府" name="都道府県[]">大阪府</option>
                          <option value="兵庫県" name="都道府県[]">兵庫県</option>
                          <option value="奈良県" name="都道府県[]">奈良県</option>
                          <option value="和歌山県" name="都道府県[]">和歌山県</option>
                        </optgroup>
                        <optgroup label="四国地方">
                          <option value="徳島県" name="都道府県[]">徳島県</option>
                          <option value="香川県" name="都道府県[]">香川県</option>
                          <option value="愛媛県" name="都道府県[]">愛媛県</option>
                          <option value="高知県" name="都道府県[]">高知県</option>
                        </optgroup>
                        <optgroup label="中国地方">
                          <option value="鳥取県" name="都道府県[]">鳥取県</option>
                          <option value="島根県" name="都道府県[]">島根県</option>
                          <option value="岡山県" name="都道府県[]">岡山県</option>
                          <option value="広島県" name="都道府県[]">広島県</option>
                          <option value="山口県" name="都道府県[]">山口県</option>
                        </optgroup>
                        <optgroup label="九州・沖縄地方">
                          <option value="福岡県" name="都道府県[]">福岡県</option>
                          <option value="佐賀県" name="都道府県[]">佐賀県</option>
                          <option value="長崎県" name="都道府県[]">長崎県</option>
                          <option value="大分県" name="都道府県[]">大分県</option>
                          <option value="熊本県" name="都道府県[]">熊本県</option>
                          <option value="宮崎県" name="都道府県[]">宮崎県</option>
                          <option value="鹿児島県" name="都道府県[]">鹿児島県</option>
                          <option value="沖縄県" name="都道府県[]">沖縄県</option>
                        </optgroup>
                      </select>
                    </div>
