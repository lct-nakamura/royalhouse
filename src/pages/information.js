        ...
        <div className="article__contents">
          <div className="container">
            <section className="article__section article__section01">
              <h2>暮らしで選ぶ、3つのおトクなパッケージ</h2>
              <p className="text-center h3 mb-5">これからの住空間にも馴染みやすいスタイルとしてシーンごとにデザイナーがパッケージ監修してご提案。</p>
              <p className="text-center h3 mb-5"><a href="https://www.royal-house.co.jp/campaign/">安心の家づくりキャンペーン</a></p>
              <p className="text-center h3 mb-5">期間：2024年4月1日（月）～2024年6月30日（日）</p>
