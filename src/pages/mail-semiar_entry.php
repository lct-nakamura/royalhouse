...
この度は、弊社開催の「建築デザイナーによる家づくりWEBセミナー」に
...
※お申込みいただいたセミナーURLは
開催日より前日にご登録いただきましたメールアドレスへ送信いたします。
※セミナーはZOOMウェビナーで開催予定です。
スマートフォンでご視聴予定の方はお手数ですが、
事前にZOOMアプリのインストールをお願いいたします。

★参加特典「デザイン実例集」をお申し込みいただいた方は
WEBセミナー開催後、郵送にてプレゼントいたします。


それでは、当日セミナーへのご参加
心よりお待ちしております。

セミナーに関して、ご質問等ございましたらお気軽に事務局までご連絡下さいませ。

———————————————————————
▼▼▼お問い合わせ先▼▼▼
ロイヤルハウス キャンペーン事務局：mail@royal-house.co.jp 

【運営元：ロイヤルハウス株式会社】
住所：〒460-0002　愛知県名古屋市中区丸の内3丁目20番3号 BPRプレイス久屋大通 4階
電話番号：0120-6186-21（フリーダイヤル）
FAX：052-959-3701（代）
———————————————————————
