			...
			<div className="article__contents">
				<div className="container">
					...
					<section className="article__section article__section01">
						...
						<a href="https://fukamori.jp/pano/royal/honbu/202009build_in/" target="_blank"><img src={withPrefix("/images/vr/vr04/sec01_img01.jpg")} alt="ビルトインガレージのある家内装" /></a>
						</div>
						<div className="button__wrap">
							<a href="https://fukamori.jp/pano/royal/honbu/202009build_in/" target="_blank" className="button button--primary">VRで体験する</a>
						</div>
					</section>
