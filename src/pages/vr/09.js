    ...
    <article className="l-article">
		<div className="article__container">
			...
			<div className="container">
				...
				<a href="https://fukamori.jp/pano/royal/honbu/20200514/" target="_blank"><img src={withPrefix("/images/vr/vr09/sec01_img01.jpg")} alt="おうち時間を楽しむ癒しの家" /></a>
				</div>
				...
				<div className="movie__wrap row">
					...
					<div className="movie text-center"><iframe width="560" height="315" src="https://www.youtube.com/embed/knPx-cumZTE" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe></div>
					</div>
				</div>
				</section>
			</div>
