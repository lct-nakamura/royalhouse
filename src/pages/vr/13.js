    ...
    <article className="l-article">
		<div className="article__container">
			...
			<div className="container">
				...
				<img src={withPrefix("/images/vr/vr13/mv.jpg")} alt="kicolo 平屋スタイル スキップフロア" />
				</div>
				<section className="article__section article__section01">
				<h2>VR見学</h2>
				<h3>画面からVR</h3>
				<div className="section__image">
				<a href="https://fukamori.jp/pano/royal/honbu/202009_1story_skip_floor/" target="_blank"><img src={withPrefix("/images/vr/vr13/sec01_img01.jpg")} alt="kicolo 平屋スタイル スキップフロア" /></a>
				</div>
				<div className="button__wrap">
					<a href="https://fukamori.jp/pano/royal/honbu/202009_1story_skip_floor/" target="_blank" className="button button--primary">VRで体験する</a>
				</div>
				</section>
				...
				<div className="movie__wrap row">
					...
					<div className="movie text-center"><iframe width="560" height="315" src="https://www.youtube.com/embed/kzg9NjpFyzY" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe></div>
					</div>
				</div>
				</section>
			</div>
