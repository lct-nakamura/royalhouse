					...
					<div className="container">
						<section className="article__section article__section03">
							...
							<div className="movie__wrap row">
								<div className="col-12 col-md-12">
									<div className="movie text-center"><iframe width="560" height="315" src="https://www.youtube.com/embed/cBCpqqwArqY?rel=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen title="子供の成長を見守る家 COMUNI GROW"></iframe></div>
								</div>
							</div>
						</section>
						<section className="article__section article__section01">
							...
							<div className="section__image">
								<a href="https://iehaco.jp/test/vr/18/3d/" target="_blank" rel="noreferrer"><img src={withPrefix("/images/vr/vr18/sec01_img01.jpg")} alt="子供の成長を見守る家 COMUNI GROW内装" /></a>
							</div>
							<div className="button__wrap">
								<a href="https://iehaco.jp/test/vr/18/3d/" target="_blank" rel="noreferrer" className="button button--primary">VRで体験する</a>
							</div>
						</section>
