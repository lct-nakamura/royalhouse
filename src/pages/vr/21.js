    ...
    <article className="l-article">
		<div className="article__container">
			...
			<div className="container">
				...
				<a href="https://iehaco.jp/park/vr/21/3d/" target="_blank"><img src={withPrefix("/images/vr/vr21/sec01_img01.jpg")} alt="グラウンドワン　平屋の家　フラットスタイル内装" /></a>
				</div>
				<div className="button__wrap">
					<a href="https://iehaco.jp/park/vr/21/3d/" target="_blank" className="button button--primary">VRで体験する</a>
				</div>
				</section>
				...
				<div className="movie__wrap row">
					<div className="col-12 col-md-12">
					<div className="movie text-center"><iframe width="560" height="315" src="https://www.youtube.com/embed/URhfenu_U7c" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
					</div>
				</div>
				</section>
			</div>
